...
const mockServices = [
  ...
  },
  {
    ...
    entrepreneur: {
      businessName: 'Lahore Embroidery Studio',
      slug: 'lahore-embroidery',
  ...
  },
  {
    ...
    entrepreneur: {
      businessName: 'Karachi Gold Works',
      slug: 'karachi-gold',
  ...
  },
  {
    ...
    entrepreneur: {
      businessName: 'Chiniot Masters',
      slug: 'chiniot-masters',
      location: { city: 'Chiniot' },
      isVerified: true,
    },
    location: { onsite: true, remote: true },
  },
  {
    _id: '5',
    title: 'Truck Art & Decorative Painting',
    slug: 'truck-art-decorative-painting',
    shortDescription: 'Vibrant Indian truck art for vehicles, walls, and custom items',
    images: ['/images/placeholder-service.jpg'],
    price: 3000,
    pricingType: 'starting_from',
    ...
    entrepreneur: {
      businessName: 'Rawalpindi Art Collective',
      slug: 'rawalpindi-art',
  ...
  },
  {
    ...
    entrepreneur: {
      businessName: 'Sialkot Leather Works',
      slug: 'sialkot-leather',
      location: { city: 'Sialkot' },
      isVerified: true,
    },
    location: { onsite: false, remote: true },
  },
