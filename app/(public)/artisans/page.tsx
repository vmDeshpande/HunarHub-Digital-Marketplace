...
const mockArtisans = [
  ...
  {
    _id: '4',
    businessName: 'Lahore Art Studio',
    slug: 'lahore-art',
  ...
  },
  {
    ...
    slug: 'kashmir-crafts',
    tagline: 'Exquisite Kashmiri embroidery',
    location: { city: 'Muzaffarabad', country: 'Pakistan' },
  ...
  {
    _id: '6',
    businessName: 'Chiniot Woodcraft',
    slug: 'chiniot-woodcraft',
    tagline: 'Heritage woodworking excellence',
    location: { city: 'Chiniot', country: 'Pakistan' },
  ...
  {
    _id: '7',
    businessName: 'Sialkot Leather Arts',
  ...
  {
    _id: '8',
    businessName: 'Swat Stone Carvers',
    slug: 'swat-stone',
    tagline: 'Ancient stone carving traditions',
    location: { city: 'Swat', country: 'Pakistan' },
